...
async def survey_chat_stream(run_id: str, request: GovernanceChatRequest) -> StreamingResponse:
    ...
    return await stream_chat_response(run_id, SURVEY_PACK, request.message)
